...
The `Smb` connector provides practical examples illustrating usage in various scenarios. Explore these [examples](https://github.com/module-ballerina-smb/tree/main/examples/), covering the following use cases:
...
* For more information go to the [`smb` package](https://central.ballerina.io/ballerinax/smb/latest).
