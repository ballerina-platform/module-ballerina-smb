...
// Expected: TOO_MANY_PARAMETERS_ON_ERROR. The SMB listener invokes `onError` with the
// error as its only argument, so a trailing `smb:Caller` is not supported.
service "OnErrorWithCallerService" on remoteServer {
